...
public class TestDataRunner implements CommandLineRunner {
    ...
    public void run(final String... args) throws Exception {
        ...
        byte[] narodowyImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/stadionnarodowy.jpg"));
        byte[] energaImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/stadionenerga.jpg"));
        byte[] atlasImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/atlasarena.jpg"));
        ...
        byte[] metallicaPhoto = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/metallica.jpg"));
        byte[] anthraxPhoto = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/anthrax.jpg"));
        byte[] slayerPhoto = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/slayer.jpg"));
        byte[] megadethPhoto = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/megadeth.jpg"));
        ...
        byte[] sonisphereFestImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/sonisphere.jpg"));
        byte[] mysticFestImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/mystic.jpg"));
        ...
        byte[] adminImage = IOUtils.toByteArray(new FileInputStream("src/main/resources/static/img/bart.jpg"));
